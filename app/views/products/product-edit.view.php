		...
		<div class="form-div">
			...
			<form width="200px" method="post" enctype="multipart/form-data">
				...
				<div class="mb-3">
					...
					<input value="<?=set_value('description',$row['description']) ?>" 
					name="description" type="text" 
					class="form-control <?= !empty($errors['description']) ? 'border-danger' : '' ?>" id="productControlInput1" placeholder="Product description">
